...
{
    public class W6099HomingSpeed : Message<uint>
    {
        byte byteSOF = (byte)'S';
        byte byteUserDataLength = 11;
        byte byteNodeNumber = 0;
        byte byteCommandCode = 0x02;
        byte byteIndexLB = 0x99;
        byte byteIndexHB = 0x60;
        byte byteEOF = (byte)'E';

        byte[] message = new byte[13];

        public W6099HomingSpeed(byte subIndex, uint val) : base(0x6099, subIndex, val)
        {
        }

        public W6099HomingSpeed(ISerialClient receiver, byte subIndex, int value) : base(receiver, 0x6099, subIndex)
        {
            message[0] = byteSOF;
    ...
    public static class HomingSpeed6099SubIndexes
    {
        public static byte SwitchSeekVelocity = 0x01;
        public static byte HomingSpeed = 0x02;
    }
}
