...
{
    public class W6091GearRatio : Message<uint>
    {
        byte byteSOF = (byte)'S';
        byte byteUserDataLength = 11;
        byte byteNodeNumber = 0;
        byte byteCommandCode = 0x02;
        byte byteIndexLB = 0x91;
        byte byteIndexHB = 0x60;
        byte byteEOF = (byte)'E';

        byte[] message = new byte[13];

        public W6091GearRatio(uint val, byte subIndex) : base(0x6091, subIndex, val) //TODO refactor this
        {
        }

        public W6091GearRatio(ISerialClient receiver, uint value, byte subIndex) : base(receiver, 0x6091, subIndex)
        {
            message[0] = byteSOF;
    ...
    public static class W6091GearRatioSubIndexes
    {
        //Drive functions 7.1.1 Tab 70
        public const byte MotorShaftRevolutions = 0x01;
        public const byte DrivingShaftRevolutions= 0x02;
    }
